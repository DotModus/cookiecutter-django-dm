"""
Django settings for {{cookiecutter.github_repository_name}} project.

Generated by https://github.com/DotModus/cookiecutter-django-dm using Django 4.0.2.
...
SECRET_KEY = env.str('SECRET_KEY', 'yhbvcdhjiuytfdfg')
...
CSRF_TRUSTED_ORIGINS = [
    env.str('CLOUDRUN_SERVICE_URL', default='http://localhost:3000')
    ]
...
ROOT_URLCONF = '{{cookiecutter.github_repository_name}}.urls'
